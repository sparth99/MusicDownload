...
def main(filename):
    ...
    system('say Downloading' + filename)
    songName = filename
    flag = 0
    ...
    if result != None:
        ...
        if metaData['collectionName'] == None:
...
def get_song_name_from_user():
    system('say Say the name of the song followed by the artist')
...
song_name = get_song_name_from_user()
main(song_name)
